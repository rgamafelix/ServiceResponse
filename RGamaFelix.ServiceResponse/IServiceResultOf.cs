...
{
  /// <summary>Get the result of the service execution</summary>
  T? Data { get; }
  ...
  /// <summary>General error type</summary>
  ResultTypeCode ResultType { get; }

  /// <summary>When implemented in a derived class, returns a string describing the error.</summary>
  /// <returns></returns>
