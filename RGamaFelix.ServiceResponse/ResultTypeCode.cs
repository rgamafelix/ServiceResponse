...
/// <summary>Code of the result of a service execution</summary>
public sealed record ResultTypeCode
{
  /// <summary>Indicates that an error occurred that is not covered by the other error codes.</summary>
  ...
  /// <summary>Indicates that the request data has validation errors.</summary>
  public static readonly ResultTypeCode InvalidData = new(nameof(InvalidData), 2, Fail);

  /// <summary>Indicates that more than one resource was found when only one was expected.</summary>
  ...
  /// <summary>Indicates that the user has been authenticated but is not authorized to perform the requested action.</summary>
  ...
  /// <remarks>To be used in catch blocks. For normal 'unexpected errors' the <see cref="GenericError" /> is recommended</remarks>
  public static readonly ResultTypeCode UnexpectedError = new(nameof(UnexpectedError), 6, Fail);

  /// <summary>Indicates that the resource was created successfully.</summary>
  public static readonly ResultTypeCode Created = new(nameof(Created), 7, Success);

  /// <summary>Indicates that the requested resource was found.</summary>
  public static readonly ResultTypeCode Found = new(nameof(Found), 9, Success);

  /// <summary>Indicates that the request was successful.</summary>
  public static readonly ResultTypeCode Ok = new(nameof(Ok), 8, Success);

  /// <summary>
  ///   Represents the result code of a service execution. These codes provide information about the success or
  ///   failure of an operation, as well as the nature of the result where applicable.
  /// </summary>
  ...
  /// <summary>Represents the name associated with the specific result type code.</summary>
  public string Name { get; }

  /// <summary>Represents the integer value associated with a specific result type code.</summary>
